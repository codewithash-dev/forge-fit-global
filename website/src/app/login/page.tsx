    ...
    <div className="min-h-screen bg-zinc-100">
      <main className="flex min-h-screen items-center justify-center px-4 py-16">
        <div className="w-full max-w-[420px] rounded-2xl bg-white p-8 shadow-lg sm:p-10">
          {/* Logo / brand – centered and large like iFIT */}
          ...
          <h1 className="text-2xl font-semibold text-[#1a1a1a] mb-6 text-center">Welcome</h1>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label htmlFor="login-email" className="block text-sm font-medium text-[#1a1a1a] mb-1.5">
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm font-medium text-[#1a1a1a] mb-1.5">
            ...
            <div className="text-right">
              <Link href="/forgot-password" className="text-sm font-medium text-[#ea580c] hover:underline">
                Forgot password?
              </Link>
            </div>
            <button
          ...
          <p className="mt-6 text-center text-sm text-zinc-600">
            ...
            <Link href="/signup" className="font-semibold text-[#ea580c] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
