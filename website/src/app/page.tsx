...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="#programs"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#ea580c] text-white font-semibold hover:bg-[#f97316] transition-colors"
              >
                Learn more
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full border-2 border-white bg-[#292524] text-white font-semibold hover:bg-[#44403c] transition-colors"
              >
                Watch now
                <span className="text-sm">&#187;</span>
              </Link>
      ...
      {/* 2. Trusted strip – exact: light beige #f8f6f2, Trusted by Millions + tagline */}
      <section className="py-10 px-6 bg-[#f8f6f2]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-[#2d2d2d] mb-1">Trusted by Millions</h2>
          <p className="text-lg text-[#6b6b6b]">ForgeFit Global: Leading in Personal Fitness</p>
        </div>
      </section>

      {/* 3. Three columns – iFIT: section bg #f8f6f2, cards #ebe6df with shadow; heading above visual, then body */}
      <section className="py-16 px-6 bg-[#f8f6f2]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Personal Training – white iPhone mockup; heading above phone */}
          <div id="programs" className="rounded-2xl bg-[#ebe6df] p-6 lg:p-8 flex flex-col shadow-md">
            <h2 className="text-xl font-bold text-[#2d2d2d] mb-6">Personal Training</h2>
                ...
                <div className="rounded-[1.9rem] overflow-hidden bg-[#0d0d0d]">
                  <div className="px-4 pt-4 pb-4 min-h-[400px] flex flex-col" style={{ backgroundColor: "#1C1D2A" }}>
                    ...
                    <div className="mt-1.5 flex flex-wrap gap-1.5 items-center">
                      ...
                      <span className="text-[10px] font-semibold text-white px-2 py-0.5 rounded bg-[#2563eb]">700</span>
          ...
          <div id="app" className="rounded-2xl bg-[#ebe6df] p-6 lg:p-8 flex flex-col shadow-md">
            <h2 className="text-xl font-bold text-[#2d2d2d] mb-6">Equipment</h2>
          ...
          <div id="workouts" className="rounded-2xl bg-[#ebe6df] p-6 lg:p-8 flex flex-col shadow-md">
            <h2 className="text-xl font-bold text-[#2d2d2d] mb-6">Workouts</h2>
      ...
      <section className="py-12 px-6 bg-[#374151]">
        <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="rounded-2xl bg-[#1f2937] p-6 text-center border border-[#4b5563]">
            <p className="text-2xl md:text-3xl font-bold text-[#ea580c]">6.4+</p>
            <p className="text-lg font-semibold text-white">Million</p>
            <p className="text-sm text-[#f97316]/90 mt-1">People workout on ForgeFit</p>
          </div>
          <div className="rounded-2xl bg-[#1f2937] p-6 text-center border border-[#4b5563]">
          ...
          <div className="absolute inset-0 flex items-end pb-[12%] pl-[8%] md:pl-[10%]">
            <div className="flex flex-col gap-3 md:gap-4">
              <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight drop-shadow-lg">
                ForgeFit
                <span className="text-[#1f2937] ml-0.5">&gt;</span>
              </p>
              <Link
                href="#why"
      ...
      {/* 5. Why ForgeFit – dark grey; left = image grid (4,4,3,2); right = large text to match reference */}
      <section id="why" className="py-16 md:py-20 px-6 bg-[#1f2937] border-y border-[#4b5563]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.58fr_0.42fr] gap-10 lg:gap-12 items-start">
            <div className="grid grid-cols-4 gap-2 w-full auto-rows-fr">
              {[
                ...
                <div
                  key={i}
                  className={`aspect-square rounded-xl overflow-hidden bg-[#374151] ${
            ...
            <div className="space-y-8 lg:space-y-10">
              <div>
                ...
                <p className="text-2xl md:text-3xl text-white/95 mt-1">workouts</p>
              </div>
              <div>
                ...
                <p className="text-white/70 text-base mt-1">180+ to motivate you</p>
              </div>
              <div>
                ...
                <p className="text-white/70 text-base mt-1">All 7 continents</p>
              </div>
              <div>
                ...
                <p className="text-white/70 text-base mt-1">Drop in to on-demand workouts</p>
              </div>
              <div>
                ...
                <p className="text-white/70 text-base mt-1">To reach your biggest goals</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* 6. Progressive programs band + two-card membership (exact iFIT layout) */}
      <section id="membership" className="bg-[#e8e9eb]">
        {/* Top band: dark grey, left = Progressive programs / subline, right = row of small square images */}
        <div className="bg-[#1f2937] px-6 py-6 md:py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="text-white/90 text-base mt-1">To reach your biggest goals</p>
          </div>
          <div className="flex gap-2 overflow-x-auto">
            {[
              ...
              <div key={i} className="w-16 h-16 md:w-20 md:h-20 flex-shrink-0 rounded-lg overflow-hidden bg-[#374151]">
                <img src={src} alt="" className="w-full h-full object-cover" />
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-10 md:py-14 flex flex-col lg:flex-row gap-8 lg:gap-12">
          <div className="flex-1 rounded-2xl overflow-hidden bg-[#1f2937] flex flex-col justify-center items-center text-center px-8 py-16 lg:py-20 min-h-[320px]">
      ...
      {/* 7. Watch the Trailer – iFIT: Trainer Games, Watch now on Prime video */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-black mb-2">Watch the Trailer</h2>
          <p className="text-zinc-600 text-sm mb-2">The search for the next global fitness star</p>
          <p className="text-black text-xl font-semibold mb-4">Let the Trainer Games begin</p>
      ...
      {/* 8. Reviews – iFIT: centered title/subtitle/button, continuous scrolling carousel (right to left) */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-2">ForgeFit Reviews</h2>
        ...
        <div className="review-carousel overflow-hidden">
          <div className="review-carousel-track">
            ...
            {[...REVIEWS, ...REVIEWS].map((r, i) => (
              <div
                key={i}
                className="w-[340px] rounded-2xl bg-[#374151] border border-[#4b5563] p-6 relative"
              >
                <span className="absolute top-4 left-6 text-6xl font-serif text-white/20 leading-none">&ldquo;</span>
                <p className="text-white/90 pt-8 pl-2 leading-relaxed">{r.quote}</p>
      ...
      {/* 9. Science – iFIT layout: left intro+3x3 grid | center headline | right images + trainer paragraph */}
      <section className="py-8 md:py-12 px-6 bg-[#1f2937]">
        <div className="grid grid-cols-1 md:grid-cols-[minmax(280px,32rem)_1fr_1fr] gap-8 md:gap-8 w-full md:items-center">
          ...
          <div className="order-1 w-full max-w-2xl min-w-0">
            <p className="text-white text-sm leading-relaxed mb-4 max-w-xl">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="aspect-square rounded-xl overflow-hidden bg-[#374151]">
                <img src="/images/equipment-three.png" alt="" className="w-full h-full object-cover" />
              </div>
              <div className="bg-gray-100 rounded-xl p-2.5 flex flex-col min-h-0 aspect-[3/4]">
                <div className="flex justify-between items-start mb-1">
                  <h3 className="text-gray-800 font-semibold text-xs">Sleep</h3>
                  <span className="text-gray-400 text-[10px]" aria-hidden>🌙</span>
                </div>
                <div className="flex-1 flex items-end gap-0.5 mb-1">
                  {[3, 5, 4, 6, 5, 7].map((h, i) => (
                    <div key={i} className="flex-1 bg-blue-500 rounded-t" style={{ height: `${h * 8}%` }} />
                  ))}
                </div>
                <p className="text-gray-600 text-[10px]">6 Hours</p>
              </div>
              <div className="aspect-square rounded-xl overflow-hidden bg-[#374151]">
                <img src="/images/science-right-1.png" alt="" className="w-full h-full object-cover" />
              </div>
              {/* Row 2: net/sky | fruit bowl | activity rings – your images */}
              <div className="aspect-square rounded-xl overflow-hidden bg-[#374151]">
                <img src="/images/workouts-grid.png" alt="" className="w-full h-full object-cover" />
              </div>
              <div className="aspect-[3/4] rounded-xl overflow-hidden bg-[#374151]">
              ...
              <div className="bg-gray-200 rounded-xl p-2.5 flex flex-col min-h-0 aspect-[3/4]">
                <div className="flex justify-between items-start mb-1">
                  <h3 className="text-gray-800 font-semibold text-xs">Heart</h3>
                  <span className="text-gray-400 text-[10px]" aria-hidden>❤️</span>
                </div>
                <div className="flex-1 flex items-end mb-1">
                  <svg className="w-full h-8 flex-shrink-0" viewBox="0 0 100 40" preserveAspectRatio="none">
                    <polyline points="0,30 10,25 20,20 30,15 40,18 50,12 60,15 70,10 80,8 90,5 100,3" fill="none" stroke="#3b82f6" strokeWidth="2" />
                  </svg>
                </div>
                <p className="text-gray-600 text-[10px]">95 bpm</p>
              </div>
              <div className="aspect-square rounded-xl overflow-hidden bg-[#374151]">
          ...
          <div className="order-3 flex flex-col gap-4 justify-center items-center md:items-end max-w-md mx-auto md:mx-0">
            <div className="w-full rounded-xl overflow-hidden bg-[#374151]">
              <img src="/images/science-right-collage.png" alt="" className="w-full h-auto object-contain" loading="lazy" />
            </div>
            <p className="text-white/90 text-sm leading-relaxed text-center md:text-right max-w-md">
